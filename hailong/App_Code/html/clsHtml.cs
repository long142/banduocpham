...
public class clsHtml
{
    ...
    static public string process_lock(int intType)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            strDraw = "<input name=\"inactive_all\" type=\"submit\" id=\"Submit1\" value='' class=\"inactive_button\" onmouseover=\"Tip('Khóa các bản ghi đã chọn lựa')\" onclick=\"return checkSubmitActiveInactiveForm(document.activeForm,'InActiveAll');\" />";
        }
        else
            strDraw = "";
        return strDraw;
    ...
    static public string process_unlock(int intType)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            strDraw = "<input name=\"active_all\" type=\"submit\" value=\"\" id=\"operation\" class=\"active_button\" onmouseover=\"Tip('Mở khóa các bản ghi đã chọn lựa')\"  onclick=\"return checkSubmitActiveInactiveForm(document.activeForm,'ActiveAll');\" />";
        }
        else
            strDraw = "";
        return strDraw;
    ...
    static public string process_del(int intType)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            strDraw = "<input name=\"delete_all\" type=\"submit\" id=\"Submit2\" value=\"\" class=\"delete_button\" onmouseover=\"Tip('Xóa các bản ghi đã chọn lựa')\"  onclick=\"return checkSubmitActiveInactiveForm(document.activeForm,'DeleteAll');\" />";
        }
        else
            strDraw = "";
        return strDraw;
