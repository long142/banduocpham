    ...
    public static bool checkImagesUploadType(HtmlInputFile uploadFile)
    {
        if (uploadFile.PostedFile.ContentLength > 0)
        {
            ...
            if (fname != "")
            {
                ...
                if (strExtension[1].ToLower().Trim() == "jpg")
                    return true;
                if (strExtension[1].ToLower().Trim() == "gif")
                    return true;
                if (strExtension[1].ToLower().Trim() == "png")
                    return true;
                if (strExtension[1].ToLower().Trim() == "jpeg")
                    return true;
    ...
    public static bool checkFileUploadType(HtmlInputFile uploadFile)
    {
        if (uploadFile.PostedFile.ContentLength > 0)
        {
            ...
            if (fname != "")
            {
                string[] separator_ListType = new string[] { "." };
                string[] strExtension = fname.Split(separator_ListType, StringSplitOptions.RemoveEmptyEntries);
                if (strExtension[1].ToLower().Trim() == "avi")
                    return false;
                if (strExtension[1].ToLower().Trim() == "mpg")
                    return false;
                if (strExtension[1].ToLower().Trim() == "flv")
                    return false;
                if (strExtension[1].ToLower().Trim() == "wmv")
                    return false;
                if (strExtension[1].ToLower().Trim() == "wma")
                    return false;
    ...
    public static string saveFrontImages(HttpPostedFile myFile, string strFolder)
    {
        ...
        if (myFile.ContentLength > 0)
        {
            ...
            if (fname != "")
            {
                string[] separator_ListType = new string[] { "." };
                string[] strExtension = fname.Split(separator_ListType, StringSplitOptions.RemoveEmptyEntries);
                strImageNewName = clsDate.DateToTimeStamp() + "." + strExtension[1];
    ...
    public static string saveImages(HtmlInputFile uploadFile, string strFolder)
    {
        ...
        if (uploadFile.PostedFile.ContentLength > 0)
        {
            ...
            if (fname != "")
            {
                string[] separator_ListType = new string[] { "." };
                string[] strExtension = fname.Split(separator_ListType, StringSplitOptions.RemoveEmptyEntries);
                strImageNewName = strExtension[0]+"_"+ clsDate.DateToTimeStamp() + "." + strExtension[1];
    ...
    public static string userUploadImages(HtmlInputFile uploadFile, string strFolder, string strTail)
    {
        ...
        if (uploadFile.PostedFile.ContentLength > 0)
        {
            ...
            if (fname != "" && uploadFile.PostedFile != null && checkImagesUploadType(uploadFile) && checkImagesUploadSize(uploadFile))
            {
                string[] separator_ListType = new string[] { "." };
                string[] strExtension = fname.Split(separator_ListType, StringSplitOptions.RemoveEmptyEntries);
                strImageNewName = clsDate.DateToTimeStamp() + "_" + strTail + "." + strExtension[1];
    ...
    public static string saveImages(HtmlInputFile uploadFile, string strFolder, int intPlace)
    {
        ...
        if (uploadFile.PostedFile.ContentLength > 0)
        {
            ...
            if (fname != "")
            {
                string[] separator_ListType = new string[] { "." };
                string[] strExtension = fname.Split(separator_ListType, StringSplitOptions.RemoveEmptyEntries);
                strImageNewName = intPlace + "_" + clsDate.DateToTimeStamp() + "." + strExtension[1];
