...
public class clsFunction
{
   ...
   public static string fnEncrypt(string password)
    ...
    public static string getNumberVN(string strNumber)
    {
        if (!String.IsNullOrEmpty(strNumber) || strNumber.Trim().Equals(""))
        {
            decimal dcNumber = decimal.Parse(strNumber);
            string result = String.Format("{0:n0}", dcNumber);
