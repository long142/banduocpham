		...
		<tr>
			...
			<br>
                    <table class="page">
                        <tr>
	                        <td>	                        
                            <input type="submit" class="button" id="BtnSubmit" onclick="return checkPermissionForm(document.activeForm,'user_permission',<%= Request.QueryString["id"] %>);" value="Phân quyền" >			                               
