...
public partial class admincp_modules_mod_news_mod_add_edit_news : System.Web.UI.UserControl
{
    ...
    private void edit_news(int intID)
    {
        ...
        //Dropdown
        DataTable dtCategory = clsDatabase.getDataTable("select * from tbl_category_news where FK_LangID = " + lang.getLangID() + " and C_PointUrl = 0 and  FK_ParentID = 0 AND FK_LangID = " + lang.getLangID() + " order by C_Rank desc");
