                        ...
                        if (dt.Rows.Count > 0)
                        {
					     ...
					     %>
							<tr class="light" >								
								...
								<td align="center" >
                                    <% if (clsSwap.getMaxRankRecord("tbl_category_news", "FK_ParentID = 0 and FK_LangID =" + lang.getLangID()) > (int)dt.Rows[i]["C_Rank"])
                                    {
                                %>
                                ...
                                %>
								<% if (clsSwap.getMinRankRecord("tbl_category_news", "FK_ParentID = 0 and FK_LangID =" + lang.getLangID()) < (int)dt.Rows[i]["C_Rank"])
                                    {
                                %>
