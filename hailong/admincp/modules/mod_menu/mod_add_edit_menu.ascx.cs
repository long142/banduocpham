...
public partial class admincp_modules_mod_menu_mod_add_edit_menu : System.Web.UI.UserControl
{
    ...
    private void edit_menu(int intID)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            intCheckBackEnd = Convert.ToInt16(dt.Rows[0]["C_BackEnd"]);
    ...
    protected void BtnSubmit_ServerClick(object sender, EventArgs e)
    {
        ...
        {
            string strSql = "insert into tbl_menu(C_Name, C_Url, C_Icon, C_Add, C_Edit, C_Del, C_Lock, C_BackEnd, C_Active, FK_ParentID, FK_LangID) values(N'" + strName + "','" + strUrl + "','" + strIcon + "'," + intCheckAdd + "," + intCheckEdit + "," + intCheckDel + "," + intCheckLock + "," + intCheckBackEnd + ",1," + intCategoryID + "," + lang.getLangID() +")";
    ...
    {        
        ...
        {
            string strSql = "update tbl_menu set C_Name = N'" + strName + "', C_Url = '" + strUrl + "', C_Icon = '" + strIcon + "', C_Add = " + intCheckAdd + ",C_Edit = " + intCheckEdit + ",C_Del = " + intCheckDel + ",C_Lock = " + intCheckLock + ",C_BackEnd = " + intCheckBackEnd + ",FK_ParentID = " + intCategoryID + " where PK_MenuID=" + intId;
            clsDatabase.ExecuteQuery(strSql);
            Response.Redirect("Default.aspx?page=menu&mod=menu");
        }
