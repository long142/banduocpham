<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_product.ascx.cs" Inherits="admincp_modules_mod_product_mod_add_edit_product" %>
		                        ...
		                        <tr>
			                        <td >
				                        ...
				                        <table class="form">
                                            ...
                                            <tr>
						                        <th>Giá sản phẩm :<span class="note">*</span></th>
						                        <td><asp:TextBox runat="server" type="text" size="70" id="txtPrice" Width="200"></asp:TextBox> VNĐ</td>
					                        </tr>	
                                            ...
                                            <tr>
						                        <th valign="top"></th>
						                        <td><asp:CheckBox id="ChkHot" runat="server" Text="Chọn làm sp nổi bật"></asp:CheckBox>
			                                </td>
					                        </tr>
					                        ...
					                        <tr>
				                               ...
				                               <td>
						                            ...
						                            <img src="images/b_drop.png"  /> [ <a href="Default.aspx?page=add_edit_product&mod=product&do=edit&id=<%= clsInput.getNumericInput("id",0) %>&act=delImg"> Xóa ảnh này </a> ]
					                            </asp:Panel>
				                               </td>
				                            </tr>
				                        </table>
