<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_category_product.ascx.cs" Inherits="admincp_modules_mod_product_mod_add_edit_category_product" %>
			                        ...
			                        <td >
				                        <table width="100%">
					                        <tr>
						                        ...
						                        <a href="Default.aspx?page=category_product&mod=product" title="Danh sách danh mục"><img src="images/icons/list.gif" class="icon" ></a>&nbsp;&nbsp;&nbsp;
				                        ...
				                        <table class="form">
					                       ...
					                       <tr style="display:none">
						                        <th valign="top"></th>
						                        <td><asp:CheckBox id="ChkMenuNgang" runat="server" Text="Hiển thị ở menu ngang (Trang bên ngoài)" Checked="true"></asp:CheckBox>
			                                </td>
					                        </tr>
					                       
					                        <tr>
						                        <th valign="top"></th>
						                        <td><asp:CheckBox id="ChkUrl" runat="server" Text="Url"></asp:CheckBox>	  
			                          <br />
