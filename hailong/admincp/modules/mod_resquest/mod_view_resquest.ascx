                        ...
                        <td>
	                        ...
	                        <table class="boder" cellSpacing="1" cellPadding="1">
				               ...
				               <%
                                   ...
                                   DataTable dtSanPham = clsDatabase.getDataTable("Select tbl_product.C_Name AS TenSanPham,tbl_category_product.C_Name AS TenLoaiSanPham from tbl_product inner join tbl_category_product on tbl_product.FK_CategoryID=tbl_category_product.PK_CategoryID where tbl_product.PK_ProductID=" + dt.Rows[0]["FK_ProductID"].ToString() );    				    				    
