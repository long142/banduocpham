			...
			<tr>
				...
				<table class="content">
					...
					<%	
                        ...
                        //========================================		    		                             	    	               			        		    
                        string strSql = "select * from tbl_slide where tbl_slide.FK_LangID = " + lang.getLangID() + strSearch + " order by tbl_slide.C_Rank desc";
                        DataTable dt;
                        ...
                        if (dt.Rows.Count > 0)
                        {
					     ...
					     %>
							<tr class="light">
                                ...
                                <%--<td align="Left">														
								&nbsp;
                                <%if (dt.Rows[i]["FK_CategoryID"].ToString().EndsWith("1"))
                                  {%>
								Slide header
                                <%} 
