<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_slide.ascx.cs" Inherits="admincp_modules_mod_slide_mod_add_edit_slide" %>
			...
			<tr>
	            ...
	            <table class="title" cellpadding="3" cellspacing="3">
                    <tr>
                        ...
                        <td width="95%"><span class="title">Quản trị danh sách các slide</span></td>
                    </tr>    		
                </table>
                <table class="content">
                    <tr>
		                        ...
		                        <tr>
			                        <td >
				                        ...
				                        <table class="form">
					                        ...
					                        <!-- END block_error -->
					                        <tr>
						                        <th>Tên slide:<span class="note">*</span></th>
						                        <td><asp:TextBox runat="server" type="text" size="70" id="txtName"></asp:TextBox></td>
					                        </tr>			                        
					                       
					                        <tr style="display:none">
						                        <th>Loại slide:<span class="note">*</span></th>
						                        <td>
                                                <asp:DropDownList id="DrdCategory" runat="server">
                                                <asp:ListItem Value="1">Slide header</asp:ListItem>
                                                <asp:ListItem Value="0">Slide footer</asp:ListItem>
                                                </asp:DropDownList>
                                                </td>
					                        </tr>	
					                        ...
					                        <tr>
				                               ...
				                               <td>
						                            ...
						                            <img src="images/b_drop.png"  /> [ <a href="Default.aspx?page=add_edit_slide&mod=slide&do=edit&id=<%= clsInput.getNumericInput("id",0) %>&act=delImg"> Xóa ảnh này </a> ]
					                            </asp:Panel>
				                               </td>
				                            </tr>
				                        </table>
