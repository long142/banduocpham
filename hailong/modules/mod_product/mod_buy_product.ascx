...
<div class="">
        ...
        <div class="guide">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <br />
          <span style="color:Black;font-weight:normal;">(Nếu bạn muốn mua nhiều sản phẩm hãy liệt kê chi tiết ở phần nôi dung)</span>
...
<div class="formcontact fl" >
  	<ul>
        ...
        <a href="<%= clsConfig.GetHostUrl() %>/buy-product/<%= intTabId %>/<%= dtCatName.Rows[0]["PK_ProductID"].ToString() %>/<%= clsFunction.RemoveUnicode(dtCatName.Rows[0]["C_Name"].ToString()) %>.aspx" class="btn-buy">Xoá</a>
        </div>
        </li>
    </ul>
